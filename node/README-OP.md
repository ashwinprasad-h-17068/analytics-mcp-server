# Zoho Analytics On-Premise MCP Server
...
A Node.js implementation of the Zoho Analytics On-Premise Model Context Protocol (MCP) Server that provides seamless integration between Zoho Analytics On-Premise and MCP Hosts such as VS Code, Claude Desktop, Cursor, and more.

## Overview

The Zoho Analytics On-Premise MCP Server enables direct access to your Zoho Analytics On-Premise data through MCP-compatible applications. This NPM package provides a lightweight, Docker-free alternative that makes it easy to integrate Zoho Analytics On-Premise into your MCP workflows.

**Key Benefits:**
- Direct access to Zoho Analytics On-Premise data from MCP-compatible applications
...
Before using the Zoho Analytics On-Premise MCP Server, ensure you have:
...
The easiest way to use the Zoho Analytics On-Premise MCP Server is through NPX (no installation required):
...
3. **Enable the Zoho Analytics On-Premise API scope**
...
|----------|-------------|
| `ANALYTICS_CLIENT_ID` | Your Zoho Analytics On-Premise OAuth client ID |
| `ANALYTICS_CLIENT_SECRET` | Your Zoho Analytics On-Premise OAuth client secret |
| `ANALYTICS_REFRESH_TOKEN` | Your Zoho Analytics On-Premise OAuth refresh token |
| `ANALYTICS_ORG_ID` | Your Zoho Analytics On-Premise organization ID |
| `ACCOUNTS_SERVER_URL` | Your Zoho Accounts Domain URL (typically `<your-accounts-uri>`) |
| `ANALYTICS_SERVER_URL` | Your Zoho Analytics On-Premise API Domain URL (typically `<your-analytics-uri>`) |
...
The Zoho Analytics On-Premise MCP server provides various tools for interacting with Zoho Analytics On-Premise.
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>Creates a new workspace in Zoho Analytics On-Premise with the given name.</td>
    </tr>
    <tr>
      <td>create_table</td>
      <td>Create Table</td>
