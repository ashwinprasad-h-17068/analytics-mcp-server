 ...
 * using fuzzy string matching. This allows us to provide helpful suggestions
 * when the user makes a spelling, formatting, or minor naming mistake.
 *
 * @param chartType - The user-provided chart type to match.
 * @param aliases - A map of supported chart type aliases.
 * @param limit - Maximum number of suggestions to return.
 * @returns The closest matching chart type aliases, ranked by similarity.
 */
function getChartTypeSuggestions(
    chartType: string,
...
export { getChartTypeSuggestions };