...
The Analytics Plus Cloud MCP Server enables direct access to your Analytics Plus Cloud data through MCP-compatible applications. This NPM package provides a lightweight, Docker-free alternative that makes it easy to integrate Analytics Plus Cloud into your MCP workflows.

**Key Benefits:**
- Direct access to Analytics Plus Cloud data from MCP-compatible applications
...
Before using the Analytics Plus Cloud MCP Server, ensure you have:
...
|----------|-------------|
| `ANALYTICS_CLIENT_ID` | Your Analytics Plus Cloud OAuth client ID |
...
The Analytics Plus Cloud MCP server provides various tools for interacting with Analytics Plus Cloud.
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>Creates a new workspace in Analytics Plus Cloud with the given name.</td>
    </tr>
    <tr>
      <td>create_table</td>
      <td>Create Table</td>
